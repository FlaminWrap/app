...
class ContrastingColor
{
    ...
    {
        //Check for a color name instead of hex 
        ...
        $sourceColor = strtolower($sourceColor);

        //If sourceColor matches a color from the array then set it to a hex value

        if (isset($colors[$sourceColor]))
        {
